class InvoicesCollection extends SimpleCollection {
    /*
     * @param {type} id
    ...
    constructor(initParamObject) {
        ...
        this.addNewModal = new EntityModal(this.id + '_newInvoiceModal', 'Rejestruj fakturę', this, 'ADD_NEW');
        this.editModal = new EntityModal(this.id + '_editInvoiceModal', 'Edytuj fakturę', this, 'EDIT');
